...
#     def delete_taxa_fn(self, name, taxa_fn):
#         comp = self.components[name]
#         if isinstance(comp, dendropy.Tree):
#             newspeciestree.prune_taxa(taxa_fn())
#         if isinstance(comp, dendropy.TreeList):
#             for 
    
    
#     def delete_taxa_uniform(self, ndelete, genetrees=None, seqs=None, speciestree=None, maxlen=None):
#         dsnew, deletion_list = self.delete_taxa(ndelete, 0, genetrees, seqs, speciestree, maxlen, True)
